...
class TD3BCAgent(AIInterface):
    def __init__(self,n_frame=1, logger=set_logger(), actor_path='./model/actor.pth',actor_name='TD3BC',device="cuda" if torch.cuda.is_available() else "cpu",**kwargs):
