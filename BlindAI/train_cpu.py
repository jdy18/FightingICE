...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder', type=str, choices=['conv1d', 'fft', 'mel'], default='mel', help='Choose an encoder for the Blind AI')
    parser.add_argument('--port', type=int, default=50051, help='Port used by DareFightingICE')
    parser.add_argument('--id', type=str, default='mlp_3_frame_256_mctsai23i' ,help='Experiment id')
