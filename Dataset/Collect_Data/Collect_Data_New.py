...
def train_model(actor, critic, actor_optimizer, critic_optimizer, iteration, port, encoder_name, experiment_id, p2, recurrent, n_frame, epoch, training_iteration, game_num, sars_path, raw_data_path):
    ...
    while iteration < training_iteration:
        ...
        for i in range(game_num):
            ...
            game_trajectories_data, game_episode_lengths, game_raw_data = collect_trajectories(actor, critic, port, 1, p2, recurrent, n_frame)
        ...
        new = OrderedDict({k: v for k, v in trajectories.items() if
                           k in ['actions', 'states', 'rewards', 'seq_len']})
...
if __name__ == '__main__':
    ...
    try:
        ...
        train_model(actor, critic, actor_optim, critic_optim, iteration, args.port, args.encoder, args.id, args.p2, args.recurrent,
                    args.n_frame, args.epoch, args.training_iteration, args.game_num, sars_path='./Data_random.pth', raw_data_path='./raw_random.npy')
    except Exception as ex:
        print(ex)
