...
def test_cql():
    ...
    args.state_shape = observation_space.shape  # or env.observation_space.n
    args.action_shape = action_space.shape  # or env.action_space.n
    args.max_action = action_space.high[0]  # float
